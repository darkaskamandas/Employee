        ...
        static void Main(string[] args)
        {
            ...
            while (choice != 5)
            {
                ...
                switch (choice)
                {
                    ...
                    case 3:
                        {
                            Console.Write("Enter the Current Employee Number to delete: ");
                            ...
                            if (!exist)
                            {
                                Console.WriteLine("\nThe Current Employee Number does not exist!\n");
                            }
                        }
                        break;
                    case 4:
                        {
                            Console.Write("Enter the Current Employee Number No to search: ");
                            int employeeNumber = int.Parse(Console.ReadLine());
                            bool exist = false;
                            foreach (Employee e in employees)
                            {
                            ...
                            if (!exist)
                            {
                                Console.WriteLine("\nCurrent Employee does not exist!\n");
                            }
                        }
                        break;
                    case 5:
                        break;
                    default:
                        Console.WriteLine("Wrong menu item. Respite step.");
                        break;
                }
            }
            Console.ReadKey();
